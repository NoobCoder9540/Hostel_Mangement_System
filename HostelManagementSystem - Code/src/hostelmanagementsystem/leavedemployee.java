 ...
 public void tabledetails()
     {
         ...
         try
         {
             String sql="select * from employee where status ='Not working'";
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(38, 59, 620, 410));
